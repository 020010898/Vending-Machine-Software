        ...
        <div id="itemButtons" class="col-md-8">
            <div class="row" id="items">
                ...
                <c:forEach var="currentItem" items="${items}">
                    <div class="col-md-4">
                        <div class="itemIn">
                            <a href="${pageContext.request.contextPath}/itemChoice/${currentItem.itemId}"
        ...
        <div class="col-md-4">
            ...
            <div id="Change">
                <form>
                    ...
                    <br/>
                    <input value="Quarters: ${change.quarterCounter} Dimes: ${change.dimeCounter} Nickels: ${change.nickelCounter} Pennies: ${change.pennyCounter}"
                           type="text" class="form-control" id="changeReturned" readonly/>
